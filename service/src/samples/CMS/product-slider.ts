export default {
  id: 'type-fab501d9-741c-4bc3-ad72-10a4a5d34f74',
  key: 'type-fab501d9-741c-4bc3-ad72-10a4a5d34f74',
  metadata: {
    type: 'ProductSlider',
    name: 'Product Slider',
    icon: '📽️',
  ...
  if (safeProducts.length === 0) {
    return (
      <SliderContainer>
        ...
        <div style={{ textAlign: 'center', padding: '2rem', color: '#666' }}>No products available</div>
      </SliderContainer>
    );
  }
  ...
  return (
    <SliderContainer>
      ...
      {safeProducts.map((product, index) => {
        ...
        const desc = product?.description?.['en-US'] || '';
        ...
        return (
          <ProductCard key={product?.id || index} href={slug}>
            ...
            <ProductInfo>
              ...
              {desc && <ProductDescription>{desc}</ProductDescription>}
