...
const PagePreview = ({isOpen, onClose, currentPage, baseURL, businessUnitKey}: Props) => {
    if (!currentPage) {
        return null;
    }
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Edit Component" size={90}>
        <PageRenderer page={currentPage} baseURL={baseURL} businessUnitKey={businessUnitKey} />
    </Modal>
  )
}
