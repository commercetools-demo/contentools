      ...
      <div class="editor-content">
        ...
        <div class="form-row">
          ...
          <select 
            ...
            @change=${(e: Event) => this._handleTypeChange((e.target as HTMLSelectElement).value as any)}
          >
        ...
        <div class="form-row">
          ...
          <input 
            ...
            @input=${(e: InputEvent) => this._updateSchemaProperty('label', (e.target as HTMLInputElement).value)}
          />
        ...
        <div class="form-row">
          <label class="form-label">
            <input 
              ...
              @change=${(e: Event) => this._updateSchemaProperty('required', (e.target as HTMLInputElement).checked)}
            />
            Required
          </label>
      ...
      case 'string':
        return html`
          <input 
            ...
            @input=${(e: InputEvent) => this._updateSchemaProperty('defaultValue', (e.target as HTMLInputElement).value)}
          />
        `;
      ...
      case 'number':
        return html`
          <input 
            ...
            @input=${(e: InputEvent) => this._updateSchemaProperty('defaultValue', Number((e.target as HTMLInputElement).value))}
          />
        `;
      ...
      case 'boolean':
        return html`
          <select 
            ...
            @change=${(e: Event) => this._updateSchemaProperty('defaultValue', (e.target as HTMLSelectElement).value === 'true')}
          >
      ...
      case 'object':
        return html`
          <textarea 
            class="form-input" 
            rows="3"
            .value=${JSON.stringify(this._editedSchema.defaultValue || (type === 'array' ? [] : {}), null, 2)}
          ...
          ${options.map((option, index) => html`
            <div class="option-item">
              <input 
                ...
                placeholder="Value" 
                .value=${option.value}
                @input=${(e: InputEvent) => this._updateOption(index, 'value', (e.target as HTMLInputElement).value)}
              />
              <input 
                type="text" 
                class="option-input" 
                placeholder="Label" 
                .value=${option.label}
                @input=${(e: InputEvent) => this._updateOption(index, 'label', (e.target as HTMLInputElement).value)}
              />
